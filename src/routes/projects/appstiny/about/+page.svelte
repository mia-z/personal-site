...
<div class={"flex flex-col justify-center space-y-5"}>
    <div class={"flex flex-col rounded-lg border-2 border-blue-400 w-2/5 mx-auto bg-[whitesmoke]"}>
        <div class={"text-2xl my-2 underline text-text-black lobster text-center"}>
            About
        </div>
        <div class={"my-2 text-lg text-text-black nunito-sans px-1 text-center"}>
            ...
            <br />
            The code repo is currently private - if you would like access <a class={"text-blue-600 underline"} href={"mailto:ryan@miaz.xyz"}>email me here</a>
        </div>
    </div>
    <div class={"flex flex-col rounded-lg border-2 border-blue-400 w-2/5 mx-auto bg-[whitesmoke]"}>
        <div class={"text-2xl my-2 underline text-text-black lobster text-center"}>
